...
STORY_EVENTS = [
    {
        ...
        "choice_b": ("이웃 밭의 물길을 함께 막는다", {
            ...
            "task": {"kind": "hold", "prompt": "터진 물길을 꾹 눌러 막으세요!", "count": 4, "time": 8.0,
    ...
    },
    {
        ...
        "choice_b": ("지금 흙을 퍼 올려 다시 쌓는다", {
            ...
            "task": {"kind": "hold", "prompt": "무너진 자리에 흙을 꾹 눌러 다지세요!", "count": 4, "time": 9.0,
    ...
    },
    {
        ...
        "choice_b": ("울타리 틈을 나뭇가지로 막는다", {
            ...
            "task": {"kind": "hold", "prompt": "울타리 틈을 꾹 눌러 막으세요!", "count": 4, "time": 8.0,
