...
def _counter(screen, text, time_frac):
    ...
    # 남은 시간 바
    w = 120
    pixel_rect(screen, (40, 34, 28), (PLOT.right - w - 8, PLOT.y + 8, w, 6), chamfer=CHAMFER_SM)
    pixel_rect(screen, (210, 180, 90), (PLOT.right - w - 8, PLOT.y + 8, int(w * max(0.0, min(1.0, time_frac))), 6), chamfer=CHAMFER_SM)
